    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                <li>
                    <a href="#" class="block py-2 px-3 font-bold from-[#B05CB0] to-[#FCB16B] bg-clip-text text-transparent bg-gradient-to-r border-b border-creativehub-dark-grey  md:border-0 md:p-0" aria-current="page">Home</a>
                </li>
                <li>
...
<header
    ...
    <div class="container max-w-[1130px] mx-auto flex flex-col items-center justify-center gap-[34px] z-10">
        <div class="flex flex-col gap-2 text-center w-fit mt-20 z-10 items-center">
            <h1 class="font-semibold text-3xl leading-[130%] md:text-[60px] xl:text-[60px]">Explore High Quality<br>Digital Products</h1>
            <p class="text-xs md:text-lg lg:text-lg text-creativehub-grey">Change the way you work to achieve better results.</p>
            <div class="flex gap-6 items-center mt-4">
                <a href="{{ route('login') }}" class="bg-clip text-transparent bg-gradient-to-tr from-[#B05CB0] to-[#FCB16B] transition-all duration-1000 text-white p-[16px_40px] w-fit h-fit rounded-[12px]  text-xs md:text-xl lg:text-xl font-semibold hover:from-[#FCB16B] hover:to-[#B05CB0] shadow-lg shadow-pink-500/50">
                    Log in
                </a>
                <a href="{{ route('register') }}" class="p-[16px_40px] w-fit h-fit rounded-[12px] text-creativehub-grey border border-creativehub-dark-grey hover:bg-[#2A2A2A] hover:text-white transition-all duration-300 text-xs md:text-xl lg:text-xl font-semibold">
                    Sign Up
                </a>
            </div>
        </div>
...
<section id="Category" class="container max-w-[1200px] px-4 mx-auto mb-[102px] flex flex-col gap-8 w-full">
    ...
    <div class="items-center gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <a href="" class="group category-card w-full h-fit p-[1px] rounded-2xl bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
            <div class="flex flex-col p-4 rounded-2xl bg-img-black-gradient group-active:bg-img-black transition-all duration-300">
        ...
        <a href=""
           class="group category-card w-full h-fit p-[1px] rounded-2xl bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
            <div
                class="flex flex-col p-4 rounded-2xl bg-img-black-gradient group-active:bg-img-black transition-all duration-300">
                <div class="w-[58px] h-[58px] flex shrink-0 items-center justify-center">
                    <img src="../assets/icons/hat.svg" alt="icon">
                </div>
                <div class="px-[6px] flex flex-col text-left">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[22px]">
        ...
        @foreach($dataHome['newProducts'] as $data)
            <div class="product-card flex flex-col rounded-[18px] bg-[#181818] overflow-hidden">
                <a href="{{ route("husain", [$data->id]) }}" class="thumbnail w-full h-[180px] flex shrink-0 overflow-hidden relative">
                    <img src="{{
                                ...
                                <div class="p-6 bg-img-black-gradient group-active:bg-img-black transition-all duration-300 rounded-2xl">
                                    <div class="flex items-center gap-5 mb-5 sm:mb-9">
                                        ...
                                        <div class="grid gap-1">
                                            ...
                                            <span class="text-sm leading-6 text-creativehub-light-grey hover:text-white">{{ $reviews->user->user_detail->title }}</span>
                                        </div>
                                    </div>
...
<section id="Tool" class="mb-[102px] flex flex-col gap-8">
    <div class="container max-w-[1200px] px-4 mx-auto flex justify-between items-center">
                   ...
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/blender.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Blender</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">3D Ul Design</p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Excel.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Excel</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Data Analysis</p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Kotlin.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Kotlin</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Android Development
                            </p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Laravel.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Laravel</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Back-End Development
                            </p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Vue.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Vue</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Front-End Development
                            </p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/figma-logo.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Figma</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Ul/UX Design</p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/flutter.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                            <p class="font-bold text-lg">Flutter</p>
                            <p class="font-semibold text-xs leading-[170%] text-creativehub-grey">Mobile Development
                            </p>
                        </div>
                    </div>
                </a>
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        class="w-[300px] h-[100px] rounded-full p-[18px_24px] bg-img-black-gradient group-hover:[background-image:linear-gradient(#181818,#181818)] group-active:bg-img-black transition-all duration-300 flex gap-4 items-center shrink-0">
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/golang.svg" class="w-full h-full object-contain"
                                 alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
