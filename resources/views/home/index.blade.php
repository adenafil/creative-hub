                   ...
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/blender.svg"
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Excel.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Kotlin.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Laravel.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/Vue.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/figma-logo.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/flutter.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
                ...
                <a href=""
                   class="group tool-card w-fit h-fit p-[1px] rounded-full bg-img-transparent hover:bg-img-purple-to-orange transition-all duration-300">
                    <div
                        ...
                        <div class="w-16 h-16 overflow-hidden flex shrink-0">
                            <img
                                src="https://raw.githubusercontent.com/fe-husni/creativehub-main/main/assets/logos/golang.svg"
                                class="w-full h-full object-contain"
                                alt="logo">
                        </div>
                        <div class="flex flex-col justify-center gap-1">
