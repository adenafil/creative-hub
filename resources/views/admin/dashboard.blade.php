<x-app-layout>
    ...
    <div class="py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mx-4 max-w-6xl lg:mx-auto">
            <div class="wrapper card-group bg-white rounded-lg shadow dark:bg-gray-800 text-white py-6 px-4">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-blue-950 dark:text-white">Total Products</h1>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-blue-950 dark:text-white">Total Order</h1>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-blue-950 dark:text-white">Total Revenue</h1>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-blue-950 dark:text-white">Total Cutomer</h1>
