                        ...
                        <tr>
                            ...
                            <td class="text-center">{{-- Review Button --}}
                                ...
                                @if(\App\Models\UserPayment::query()->where('id',
                                    ...
                                    <button id="btn-review" data-modal-target="crud-modal-{{ $purchase->product_id }}" data-modal-toggle="crud-modal-{{ $purchase->product_id }}" data-product-id="{{ $purchase->product_id }}" class="btn-review font-bold text-blue-500 hover:text-blue-300" type="button" data-tooltip-target="tooltip-review-{{$purchase->product_id}}" data-tooltip-placement="top" >
                                        ...
                                        <div class="reviews-star">
                                            ...
                                            <div class="grid gap-4 mt-8 mb-4 grid-cols-2">
                                                <div class="col-span-2">
                                                    <label for="comment" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mx-5">Product Reviews</label>

                                                    {{-- Check Here  --}}
                                                    <textarea name="comment" id="comment" rows="4" class="block p-2.5 w-[90%] mx-auto text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write Your Review Here">{{$comments[$purchase->product_id] ?? "Write Your Review Here"}}
                                                                </textarea>
                                                </div>
                                            </div>
                                            <button id="submitButton" type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ms-5 mb-5" disabled>
                                                Submit
                                            </button>
                                        </div>
                                    </form>
